...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <body>
        {isDashboard ? (
          // Render only children without global layout
          <>{children}</>
        ) : (
          // Normal layout
          <div className="w-full flex flex-col relative">
            ...
            <div className="fixed bottom-0 left-0 w-full  bg-white rounded-t md:hidden flex justify-between items-center px-4 py-1">
              <div  onClick={() => setShowBottomCategory(!showBottomCategory)} className="flex flex-col items-center text-[12px] font-semibold text-[#167389] capitalize">
            ...
            <div className="absolute top-0 left-0 w-[20rem] h-full overflow-auto scrollbar-hide z-50 bg-white md:hidden block">
              <div className="flex justify-end mr-3 cursor-pointer" onClick={() => setShowBottomCategory(false)}>
                <RxCross2 />
